...
public final class Album {
     ...
     * Preview Album.
     */
    public static GalleryAlbumWrapper galleryAlbum(Activity activity) {
     ...
     * Preview Album.
     */
    public static GalleryAlbumWrapper galleryAlbum(Fragment fragment) {
     ...
     * Preview Album.
     */
    public static GalleryAlbumWrapper galleryAlbum(android.support.v4.app.Fragment fragment) {
